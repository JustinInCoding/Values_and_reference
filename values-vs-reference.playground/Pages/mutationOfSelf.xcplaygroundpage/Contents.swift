...
var pointReference: [PointReference] = [] {
	didSet {
		print("didSet PointReference", pointReference)
	}
}
...
pointReference.append(pr1)
pointReference.append(pr2)
pointReference.append(pr1)

pr1.x = 100
pointReference[0].x = -300
pointReference[1].transpose()
